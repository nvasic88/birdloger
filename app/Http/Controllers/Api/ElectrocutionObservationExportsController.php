...
use App\Exports\ElectrocutionObservations\ElectrocutionObservationsExportFactory;
use App\Jobs\PerformExport;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Validation\Rule;

class ElectrocutionObservationExportsController
{
    /**
     * @var ElectrocutionObservationsExportFactory
     */
    protected $electrocutionObservationsExport;

    /**
     * Construct controller instance.
     *
     * @param ElectrocutionObservationsExportFactory $electrocutionObservationsExport
     */
    public function __construct(ElectrocutionObservationsExportFactory $electrocutionObservationsExport)
    {
        $this->electrocutionObservationsExport = $electrocutionObservationsExport;
    }
    ...
    {
        return ElectrocutionObservationsExport::availableColumns();
    }
    ...
    {
        return $this->electrocutionObservationsExport->createFromRequest($request);
    }
}
