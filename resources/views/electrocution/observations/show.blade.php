...
@section('content')
    <div class="box">
        ...
        <a href="{{ route('contributor.field-observations.edit', $fieldObservation) }}"
...
@section('breadcrumbs')
    <div class="breadcrumb" aria-label="breadcrumbs">
        <ul>
            ...
            <li>
                <a href="{{ route('contributor.field-observations.index') }}">{{ __('navigation.my_field_observations') }}</a>
            </li>
