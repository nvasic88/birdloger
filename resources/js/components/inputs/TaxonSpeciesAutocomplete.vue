<template>
  <b-field :label="label" class="nz-taxon-species-autocomplete" :type="error ? 'is-danger' : null" :message="message">
    <b-field grouped>
...
export default {
  name: 'nzTaxonSpeciesAutocomplete',
  ...
  props: {
    ...
    url: {
      type: String,
      default: () => route('api.taxa.species')
    },
    value: {
      type: String,
      default: ''
