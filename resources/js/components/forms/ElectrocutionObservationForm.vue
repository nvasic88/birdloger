<template>
  <form :action="action" method="POST" :lang="locale" class="electrocution-observation-form">
      ...
      <div class="columns">
        ...
        <div class="column">
          <b-field
            ...
            :message="form.errors.has('duration') ? form.errors.first('duration') : null"
          >
      ...
      <div class="columns">
        <div class="column">
          <b-field
            ...
            label-for="distance_from_pillar"
            :error="form.errors.has('distance_from_pillar')"
            :message="form.errors.has('distance_from_pillar') ? form.errors.first('distance_from_pillar') : null"
          >
            <b-input id="distance_from_pillar" name="distance_from_pillar" type="number"
                     v-model="form.distance_from_pillar"/>
          </b-field>
        </div>
        <div class="column">
          <b-field
      ...
      <div class="columns">
        <div class="column">
          <b-field
            ...
            label-for="age"
            :error="form.errors.has('age')"
            :message="form.errors.has('age') ? form.errors.first('age') : null"
          >
            <b-input id="age" name="age" type="number" v-model="form.age"/>
          </b-field>
        </div>
        <div class="column">
          <b-field
...
export default {
  ...
  methods: {
    ...
    /**
     * Add observer for electrocution observation
     *
     */
    addObserver() {
      let pass = true;
