<template>
  <div class="electrocution-observations-import">
...
export default {
  name: 'nzElectrocutionObservationsImport',
  components: {
    NzUserAutocomplete,
    NzColumnsPicker
  },
  ...
  methods: {
    ...
    submit() {
      ...
      axios.post('/api/electrocution-observation-imports', this.makeForm())
    ...
    checkStatus() {
      return axios.get(`/api/electrocution-observation-imports/${this.currentImport.id}`).then(({ data }) => {
        this.currentImport = data
