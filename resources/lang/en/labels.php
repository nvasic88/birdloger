...
return [
    ...
    'electrocution_observations' => [
        ...
        'voltage' => 'Voltage',
        'iba' => 'IBA',
        'time_of_corpse_found' => 'Time of corpse found (h)',
        'electrocution' => 'Electrocution',
        'collision' => 'Collision',
        'unknown' => 'Unknown',
        'choose_a_position' => 'Choose corpse position',
        'ground' => 'Ground',
        'pillar' => 'Pillar',
        'choose_a_state' => 'Choose condition of the dead individual',
        'alive' => 'Alive bird',
        'fresh_corpse' => 'Whole fresh corpse',
        'in_decay_state' => 'In decay state',
        'corpse_remains' => 'Corpse remains',
        'dry_remains' => 'Dry corpse remains',
        'fresh_remains' => 'Fresh corpse remains',
    ],

    'poaching_observations' => [
        'indigenous' => 'Indigenous',
        'dead_from_total' => 'Dead individuals',
        'alive_from_total' => 'Alive individuals',
        ...
        'case_name' => 'Case name',
        'case_submitted_to' => 'Case submitted to',
        'case_against' => 'Case against',
        'case_against_pib' => 'Tax identification number',
        'case_against_mb' => 'Identification number',
        'individual' => 'Individual',
        'legal_entity' => 'Legal entity',
        'add_suspect' => 'Add suspect',
        'suspect_name' => 'Name',
        'suspect_place' => 'Place',
        'suspect_profile' => 'Profile',
        'suspect_phone' => 'Phone',
        'suspect_email' => 'Email',
        'suspect_social_media' => 'Social medias',
        'suspect_note' => 'Various',
        'remove_suspect' => 'Remove suspect',
        'new_suspect_details' => 'New suspect details',
        'any_field_is_required' => 'Any field is required',
        'must_select_source' => 'Source must be selected',
